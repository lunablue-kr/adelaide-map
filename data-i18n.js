...
const I18N = {
  ko:{
    ...
    layers:{suburb:'서버브 경계',transit:'대중교통',schools:'학교',hospitals:'의료',marts:'마트',restaurant:'식당',cafe:'카페',pubs:'술집',parks:'공원·레저',shopping:'쇼핑',sight:'명소',facility:'시설'},
  ...
  en:{
    ...
    layers:{suburb:'Suburbs',transit:'Public transport',schools:'Schools',hospitals:'Healthcare',marts:'Groceries',restaurant:'Restaurants',cafe:'Cafés',pubs:'Pubs & bars',parks:'Parks & leisure',shopping:'Shopping',sight:'Sights',facility:'Facilities'},
