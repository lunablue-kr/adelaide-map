...
const I18N = {
  ko:{
    ...
    lblPreset:'목적별 보기', presetBtn:'목적별', presets:{student:'유학생',traveler:'여행자',runner:'러너'},
    layers:{suburb:'서버브 경계',transit:'대중교통',schools:'학교',hospitals:'의료',marts:'마트',restaurant:'식당',cafe:'카페',pubs:'술집',parks:'공원·레저',runs:'러닝코스',shopping:'쇼핑',sight:'명소',facility:'시설',admin:'생활·행정'},
  ...
  en:{
    ...
    lblPreset:'By purpose', presetBtn:'Purpose', presets:{student:'Student',traveler:'Visitor',runner:'Runner'},
    layers:{suburb:'Suburbs',transit:'Public transport',schools:'Schools',hospitals:'Healthcare',marts:'Groceries',restaurant:'Restaurants',cafe:'Cafés',pubs:'Pubs & bars',parks:'Parks & leisure',runs:'Running trails',shopping:'Shopping',sight:'Sights',facility:'Facilities',admin:'Civic & services'},
